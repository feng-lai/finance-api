<?php
include_once ('../extend/umeng/com/alibaba/openapi/client/serialize/SerializerProvider.class.php');
include_once ('../extend/umeng/com/alibaba/openapi/client/util/SignatureUtil.class.php');
class SyncAPIClient {
	var $clientPolicy;
